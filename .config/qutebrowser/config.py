...
config.bind('SM', 'spawn youtube-dl -o /windows10/Users/annaj/Videos/%(title)s.%(ext)s {url}')
config.bind('SA', 'spawn youtube-dl -f bestaudio[ext=m4a] -o /windows10/Users/annaj/Music/%(title)s.%(ext)s {url}')
